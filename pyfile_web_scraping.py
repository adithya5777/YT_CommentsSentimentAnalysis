...
def scrapfyt(url):
  ...
  driver = webdriver.Chrome(service=Service(r"C:Users/adith/Downloads/YoutubeCommentScrapingandAnalysis-main/YoutubeCommentScrapingandAnalysis-main/chromedriver.exe"), options=option) # For testing in windows
  ...
  video_comment_without_replies = str(len(commentsfile.axes[0])) + ' Comments' #only comments without replies
  driver.close()
  return all_comments, video_comment_without_replies
